...
@Component({
  selector: 'app-test-history-dashboard',
  templateUrl: './test-history-dashboard.component.html',
  styleUrl: './test-history-dashboard.component.css'
})
export class TestHistoryDashboardComponent implements OnInit {
  examResults: any[] = [];
  filteredResults: any[] = [];
  isLoading = true;
  errorMessage = '';

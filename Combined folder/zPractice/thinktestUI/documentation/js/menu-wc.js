...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">online-mcq-exam documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/LoggedInFooterComponent.html" data-type="entity-link" >LoggedInFooterComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/StartExamComponent.html" data-type="entity-link" >StartExamComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/TestHistoryComponent.html" data-type="entity-link" >TestHistoryComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/TestResultService.html" data-type="entity-link" >TestResultService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">

...
import { Exam, OptionPostDTO, QuestionPostDTO, SectionGetDTO, SectionPostDTO } from '../../../core/interfaces/exam.model';
import { ApiService } from '../../../core/services/api.service';
import { NgModule } from '@angular/core';

@Component({
  selector: 'app-create-exam-section',
  templateUrl: './create-exam-section.component.html',
  styleUrl: './create-exam-section.component.css'
})
export class CreateExamSectionComponent implements OnInit {
  examForm!: FormGroup;
  ...
  loadSections(examId: number): void {
    this.sectionService.getSectionsByExamIdE(examId).subscribe((sections: SectionGetDTO[]) => {
